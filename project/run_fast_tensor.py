...
def default_log_fn(epoch, total_loss, correct, losses, diff_time):
    print("Epoch ", epoch, " loss ", total_loss, "correct", correct, " time per epoch", diff_time)
...
class Linear(minitorch.Module):
    ...
    def forward(self, x):
        ...
        out = x.view(batch, in_size) @ self.weights.value + self.bias.value
        return out
    ...
    def train(self, data, learning_rate, max_epochs=500, log_fn=default_log_fn):
        ...
        for epoch in range(max_epochs):
            ...
            if epoch % 10 == 0 or epoch == max_epochs:
                ...
                log_fn(epoch, total_loss, correct, losses, diff_time)
